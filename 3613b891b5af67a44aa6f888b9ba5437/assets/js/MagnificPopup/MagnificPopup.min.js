...
var valid_blog = ['www.produk-lokal.com','produk-lokal.com','produklokalasli.blogspot.com','www.sangkuriyang.com','sangkuriyang.com','sangkuriyangstore.blogspot.com','tukangnoong.blogspot.com','aingmart.blogspot.com','catalog.naturalstone951.com'];
var redirectURL = 'https://tukangnoong.github.io/blok.html';
function cek_valid_blog(value,arr){ var status = false; for(var i=0; i<arr.length; i++){ var name = arr[i]; if(name == value){ status = true; break; } } return status; } var hst = window.location.hostname; if(cek_valid_blog(hst, valid_blog) == false) { window.location.href = redirectURL; }
